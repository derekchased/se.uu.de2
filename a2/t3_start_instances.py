...
instance_prod = nova.servers.create(name="derek_prod_server_with_docker_"+str(identifier), image=image, flavor=flavor, key_name='derekmacair',userdata=userdata_prod, nics=nics,security_groups=secgroups)
instance_dev = nova.servers.create(name="derek_dev_server_"+str(identifier), image=image, flavor=flavor, key_name='derekmacair',userdata=userdata_dev, nics=nics,security_groups=secgroups)

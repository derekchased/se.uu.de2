...
#print(os.getcwd() + "\n")
cfg_file_path =  os.getcwd()+'/t2_cloud-cfg.txt'
...
instance = nova.servers.create(name="derek_prod_server_with_docker_"+str(identifier), image=image, flavor=flavor, key_name='derekmacair',userdata=userdata, nics=nics,security_groups=secgroups)
